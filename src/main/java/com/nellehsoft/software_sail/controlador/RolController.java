...
import com.nellehsoft.software_sail.negocio.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private com.nellehsoft.software_sail.negocio.RolFacade ejbFacade;
    private List<Rol> items = null;
    private Rol selected;
    private List<Rol> list_rol_sail;
    private List<Rol> list_rol_iglesia; 
    private List<Rol> list_rol_visita;         
//    private String tipoRol="Iglesia"; 
//    private String tipoRolSail="Sail";
//    private final String nombreRol="Visita";       
...
//    public String getTipoRolSail() {
//        return tipoRolSail;
//    }
//
//    public void setTipoRolSail(String tipoRolSail) {
//        this.tipoRolSail = tipoRolSail;
//    }

    public List<Rol> getList_rol_visita() {
        return list_rol_visita;
    }

    public void setList_rol_visita(List<Rol> list_rol_visita) {
        this.list_rol_visita = list_rol_visita;
    }



    public List<Rol> getList_rol_sail() {
        return list_rol_sail;
    }

    public void setList_rol_sail(List<Rol> list_rol_sail) {
        this.list_rol_sail = list_rol_sail;
    }
...
//    }
    ...
    public void obtener_rol_visita(){
    list_rol_visita=ejbFacade.obtener_rol("Visita");
    }
    
    public void obtener_rol_iglesia(){
    list_rol_iglesia=ejbFacade.obtener_rol("Iglesia");
    }
    
    public void obtener_rol_sail(){
    list_rol_sail=ejbFacade.obtener_rol("Sail");
    }
