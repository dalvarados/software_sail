...
@ManagedBean
@RequestScoped
public class cartaMembresiaReportBean {
    @EJB 
   ...
   public void verPDF() throws JRException, IOException{
    ...
    File jasper= new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/reportes/rpt_carta_membresia.jasper"));
   ...
   public void exportarPDF() throws JRException, IOException{
    ...
    HttpServletResponse  response=(HttpServletResponse) FacesContext.getCurrentInstance().getExternalContext().getResponse();
    response.addHeader("Content-disposition", "attachment; filename=rpt_carta_membresia.pdf");
